...
echo substr("abcdef",2),'<br>'; 	//从左到右的第2+1个字符开始返回所有字符
echo substr("abcdef",-2),'<br>'; 	//从右到左的第2个字符开始返回所有字符
echo substr("abcdef",0,2),'<br>';	//从左到右的第0+1个字符开始返回所有字符，从左到右（最左）保留2个字符
echo substr("abcdef",1,-2),'<br>';	//从左到右的第1+1个字符开始返回所有字符，（最右）减少2个字符
